 ...
 * @subpackage  io
 */
class MemcacheWrapper extends \Yana\Core\Object implements \Yana\Data\Adapters\MemCache\IsWrapper
{
    ...
    {
        return $this->_getMemCache()->addServer($server->getHostName(), $server->getPort(), null, $server->getWeight());
    }
