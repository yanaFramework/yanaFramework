 ...
 * @subpackage  data
 */
class MemCacheAdapter extends \Yana\Core\AbstractCountableArray implements \Yana\Data\Adapters\IsDataAdapter
{
    ...
    public function __construct(\Yana\Data\Adapters\MemCache\IsWrapper $memCache, $prefix = __CLASS__, $lifetime = 0)
    {
        ...
        if (!$this->_isAvailable()) {
            ...
            throw new \Yana\Data\Adapters\MemCache\ServerNotAvailableException($message);
        }
