...
/**
 * <<exception>> When a file name is not valid for a language file.
 *
 * @package     yana
 * @subpackage  core
 */
class InvalidFileNameException extends \Yana\Core\Exceptions\Translations\TranslationException
{
