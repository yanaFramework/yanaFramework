...
/**
 * <<exception>> User mail missing.
 *
 * Thrown when a form requires a user mail but none is provided.
 *
 * @package     yana
 * @subpackage  core
 */
class MissingMailException extends \Yana\Core\Exceptions\User\UserException
{
