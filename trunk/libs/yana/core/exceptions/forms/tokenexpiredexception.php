...
/**
 * <<exception>> CSRF-token has expired.
 *
 ...
 *
 * The token auto-expires when used, to prevent an attacker from trying to fixate a token, or using a brute-force approach.
 *
 * @package     yana
 * @subpackage  core
 */
class TokenExpiredException extends \Yana\Core\Exceptions\Forms\TimeoutException
{
