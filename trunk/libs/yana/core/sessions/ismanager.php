...
interface IsManager
{
     ...
     *
     * @param  \Yana\Core\Sessions\IsSessionHandler  $handler   new session safe handler
     * @param  bool                                  $autoSave  additionally registers session_write_close() as shutdown function
     */
    public function setSaveHandler(\Yana\Core\Sessions\IsSessionHandler $handler, $autoSave = false);
