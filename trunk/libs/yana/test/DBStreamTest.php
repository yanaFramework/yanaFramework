...
class DbStreamTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        if ($this->dbsobj instanceof DBStream) {
     ...
     * @test
     */
    function testImportSQLInvalidArgument()
    {
     ...
     * @test
     */
    function testQueryInvalidArgument1()
    {
        $this->dbsobj->query(3);
    }
     ...
     * @test
     */
    function testQuoteInvalidArgument()
    {
    ...
    public function testEquals()
    {
        ...
        $schema = XDDL::getDatabase('check');
        $anotherObject = new DbStream($schema);
