 ...
 * @package  test
 */
class StandardCheckTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var  \Yana\Security\Passwords\Checks\StandardCheck
     */
    protected $_object;
    ...
    protected function setUp()
    {
        ...
        $this->_object = new \Yana\Security\Passwords\Checks\StandardCheck(new \Yana\Security\Passwords\NullAlgorithm());
    }
    ...
    public function testInvoke()
    {
        ...
        $this->assertTrue($this->_object->__invoke($this->_user->setId("Test")->setPassword("UNINITIALIZED"), "Test", $password));
    }
