 ...
 * @ignore
 */
class MySessionManager extends \Yana\Security\Data\SessionManager
{
    ...
    {
        \Yana\Security\Data\SessionManager::$rules = array();
        \Yana\Security\Data\SessionManager::getInstance()->cache = array();
    }
...
class SessionManagerTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        \Yana\Security\Data\SessionManager::setDatasource($this->_database);
        \Yana\User::setDatasource($this->_database);
        $this->_sessionManager = \Yana\Security\Data\SessionManager::getInstance();
    }
    ...
    public function testCheckPremission()
    {
        ...
        \Yana\Security\Data\SessionManager::addSecurityRule(array('plugin_user_group', 'checkGroupsAndRoles'));
    ...
    public function testCheckPremission1()
    {
        ...
        MySessionManager::dropSecurityRules();
        \Yana\Security\Data\SessionManager::addSecurityRule(array('plugin_user', 'checkSecurityLevel'));
        /**
         * check_baricons
         *
         * @type        primary
    ...
    public function testSerialize()
    {
        ...
        $this->assertTrue($unserialize instanceof \Yana\Security\Data\SessionManager, 'the value should be an instance of SessionManager');
