...
class MenuCollectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->object = new \Yana\Plugins\Menus\MenuCollection();
    }
    ...
    {
        $o = new \Yana\Plugins\Menus\Menu(new \Yana\Plugins\Menus\NullMenuBuilder());
        $this->assertSame($o, $this->object->offsetSet('test', $o));
        $this->assertSame($o, $this->object->offsetGet('test'));
    }
