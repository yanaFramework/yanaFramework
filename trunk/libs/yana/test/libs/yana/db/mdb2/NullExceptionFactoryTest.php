 ...
 * @package  test
 */
class NullExceptionFactoryTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @var \Yana\Db\Mdb2\NullExceptionFactory
     */
    protected $object;
    ...
    {
        $this->assertTrue($this->object->toException(new \MDB2_Error()) instanceof \Yana\Db\DatabaseException);
    }
