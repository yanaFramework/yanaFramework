 ...
 * @ignore
 */
class LanguageTokenFilterTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @var \Yana\Views\Helpers\PreFilters\LanguageTokenFilter
     */
    protected $object;
    ...
    protected function setUp()
    {
        ...
        $this->object = new \Yana\Views\Helpers\PreFilters\LanguageTokenFilter($this->container);
    }
    ...
    {
        $this->assertSame("Test!", $this->object->__invoke("Test!", new \Smarty_Internal_Template("name", new \Smarty())));
    }
