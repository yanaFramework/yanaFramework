 ...
 * @package  test
 */
class VerticalLayoutTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @var \Yana\Views\Helpers\Html\MenuLayouts\VerticalLayout
     */
    protected $object;
    ...
    {
        $this->object = new \Yana\Views\Helpers\Html\MenuLayouts\VerticalLayout();
    }
    ...
    public function test__invoke()
    {
        ...
        $expected1 = '<ul class="menu root"><li class="menu"><div class="menu_head" onclick="yanaMenu(this)">a</div><ul class="menu">' .
        ...
        $expected2 = '<ul class="menu root"><li class="menu"><div class="menu_head" onclick="yanaMenu(this)">a</div><ul class="menu">' .
