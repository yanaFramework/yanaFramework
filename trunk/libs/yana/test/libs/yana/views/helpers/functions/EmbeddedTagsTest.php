...
class EmbeddedTagsTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->object = new \Yana\Views\Helpers\Functions\EmbeddedTags(new \Yana\Core\Dependencies\Container($configuration));
    }
    ...
    /**
     * @covers Yana\Views\Helpers\Functions\EmbeddedTags::__invoke
