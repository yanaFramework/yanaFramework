 ...
 * @ignore
 */
class MyFileResource extends \Yana\Views\Resources\FileResource
{
...
class FileResourceTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Yana\Views\Resources\MyFileResource
     */
    protected $object;
    /**
    ...
    protected function setUp()
    {
        ...
        $this->object = new \Yana\Views\Resources\MyFileResource($this->container);
    }
    ...
    public function testFetch()
    {
        ...
        $this->assertSame(\filemtime(__FILE__), $mtime);
        $this->assertSame(file_get_contents(__FILE__), $source);
    }
    ...
    public function testFetchTimestamp()
    {
        ...
        $this->assertSame(\filemtime(__FILE__), $this->object->fetchTimestamp(__FILE__));
    }
