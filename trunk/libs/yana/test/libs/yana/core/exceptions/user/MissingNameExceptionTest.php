 ...
 * @package  test
 */
class MissingNameExceptionTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @var \Yana\Core\Exceptions\User\MissingNameException
     */
    protected $object;
    ...
    {
        $this->object = new \Yana\Core\Exceptions\User\MissingNameException();
    }
