...
class NullDataProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Yana\Core\MetaData\NullDataProvider
     */
    protected $object;
    ...
    {
        $this->object = new \Yana\Core\MetaData\NullDataProvider();
    }
    ...
    {
        $expected = new \Yana\Core\MetaData\PackageMetaData();
        $actual = $this->object->loadOject('some id');
