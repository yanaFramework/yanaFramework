 ...
 * @package  test
 */
class LowerCasedMapperTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @var \Yana\Core\Autoloaders\LowerCasedMapper
     */
    protected $object;
    ...
    {
        $this->object = new \Yana\Core\Autoloaders\LowerCasedMapper();
    ...
    public function testMapClassNameToFilePath()
    {
        ...
        $this->assertSame('DirPrenamespace/classExt', $this->object->mapClassNameToFilePath('NameSpace_Class'));
