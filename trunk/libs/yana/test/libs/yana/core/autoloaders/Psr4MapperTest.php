 ...
 * @package  test
 */
class Psr4MapperTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @var \Yana\Core\Autoloaders\Psr4Mapper
     */
    protected $object;
    ...
    {
        $this->object = new \Yana\Core\Autoloaders\Psr4Mapper();
    ...
    public function testMapClassNameToFilePath()
    {
        ...
        $this->assertSame('DirPreClass_NameExt', $this->object->mapClassNameToFilePath('Class_Name'));
        ...
        $this->assertSame('DirPreName_Space/Class_NameExt', $this->object->mapClassNameToFilePath('Name_Space\\Class_Name'));
