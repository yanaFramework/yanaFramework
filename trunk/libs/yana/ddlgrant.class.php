...
class DDLGrant extends DDL
{
     ...
     * @access  public
     * @static
     * @param   array  $grants  list of DDLGrant objects
     * @param   bool   $select  must be selectable
     * @param   bool   $insert  must be insertable
     * @param   bool   $update  must be updatable
     * @param   bool   $delete  must be deletable
    ...
    {
        $hasPermission = true;
        /* @var $ddlGrant DDLGrant */
        foreach ($grants as $ddlGrant)
        {
            assert('$ddlGrant instanceof DDLGrant;');
            $hasPermission = $ddlGrant->checkPermission($select, $insert, $update, $delete, $grant);
            if ($hasPermission) {
                 break;
            }
        }
