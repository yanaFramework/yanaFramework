...
class Collection extends \Yana\Core\AbstractCollection
{
     ...
     *
     * @param   scalar                                $offset  requirement id
     * @param   \Yana\Core\Autoloaders\IsRequirement  $value   requirement that shoud be added
     * @return  \Yana\Core\Autoloaders\IsRequirement
    ...
    public function offsetSet($offset, $value)
    {
        ...
        if (!$value instanceof \Yana\Security\Rules\Requirements\IsRequirement) {
            $message = "Instance of \Yana\Security\Rules\IsRequirement expected. " .
