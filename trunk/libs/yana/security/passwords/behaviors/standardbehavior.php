...
class StandardBehavior extends \Yana\Security\Passwords\Behaviors\AbstractBehavior
{
     ...
     *
     * @param  \Yana\Security\Users\IsUser  $user  the user to operate on
     */
    protected function _resetFailureCount(\Yana\Security\Users\IsUser $user)
    {
        $user
            ->setFailureCount(0)
            ->setFailureTime(0);
     ...
     * @param  \Yana\Security\Users\IsUser  $user  the user to operate on
     */
    protected function _increaseFailureCount(\Yana\Security\Users\IsUser $user)
    {
        $user
