 ...
 */
class HorizontalLayout extends \Yana\Templates\Helpers\Html\MenuLayouts\AbstractLayout
{
     ...
     *
     * Converts the array elements to a horizontal menu bar with foldable submenus and clickable items.
     * Items are listed horizontal on the first level, but vertical on the second and any other level.
     * Sub-menus always open under the clicked element.
     *
