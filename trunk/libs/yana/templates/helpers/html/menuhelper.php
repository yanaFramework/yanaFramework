...
namespace Yana\Templates\Helpers\Html;
...
class MenuHelper extends \Yana\Core\Object
{
    ...
    /**
     * @var \Yana\Templates\Helpers\Html\MenuLayouts\IsLayout
     */
     ...
     * @var int
     */
    private $_useKeys = \Yana\Templates\Helpers\Html\MenuLayouts\KeyEnumeration::DONT_CONVERT_HREF;
     ...
     *
     * @param  \Yana\Templates\Helpers\Html\MenuLayouts\IsLayout  $layout  a class that does the conversion
     */
    public function __construct(\Yana\Templates\Helpers\Html\MenuLayouts\IsLayout $layout)
    {
        $this->_layout = $layout;
    }
     ...
     * @return  \Yana\Templates\Helpers\Html\MenuHelper
     */
    public static function factory($layoutNumber = 1)
    {
        ...
        {
            case 2:
                $layout = new \Yana\Templates\Helpers\Html\MenuLayouts\VerticalLayout();
                break;
            case 3:
                $layout = new \Yana\Templates\Helpers\Html\MenuLayouts\HorizontalLayout();
                break;
            case 1:
            default:
                $layout = new \Yana\Templates\Helpers\Html\MenuLayouts\SimpleLayout();
                break;
        }
        return new \Yana\Templates\Helpers\Html\MenuHelper($layout);
    }

    /**
     * @return  \Yana\Templates\Helpers\Html\MenuLayouts\IsLayout
     */
