 ...
 * @subpackage  db
 */
class BeforeInsert extends \Yana\Db\Helpers\Triggers\AbstractTrigger
{
    ...
    {
        return $this->_container->table->getTriggerBeforeInsert();
    }
    ...
    {
        return \Yana\Db\Helpers\Triggers\TypeEnumeration::BEFORE_INSERT;
    }
