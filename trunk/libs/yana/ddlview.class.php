 ...
 * @subpackage  database
 */
class DDLView extends DDLNamedObject implements IsIncludableDDL
{
    /**#@+
     * @ignore
     * @access  protected
    ...
    protected $xddlTags = array(
        ...
        'field'       => array('fields',      'array', 'DDLViewField', 'column'),
    ...
    /** @var DDLViewField[] */ protected $fields = array();
     ...
     * <ul>
     *   <li> DDLView::NONE - no check option </li>
     *   <li> DDLView::CASCADED - recursive checks </li>
     *   <li> DDLView::LOCAL - local checks only </li>
     * </ul>
     *
     ...
     *
     * DDLView::NONE evaluates to bool(false), while both DDLView::CASCADED and
     * DDLView::LOCAL evaluate to bool(true).
     *
     * @access  public
     * @return  int
     * @name    DDLView::getCheckOption()
     */
    ...
    public function getField($name)
    {
        ...
        if (isset($this->fields[$name])) {
            ...
            throw new InvalidArgumentException("Field with the name '$name' is not defined");
        }
    }
