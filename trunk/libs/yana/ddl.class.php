...
abstract class DDL extends Object
{
                ...
                case 'array':
                    ...
                    if (isset($tag[2])) {
                        ...
                        foreach ($this->$property as $object)
                        {
                            ...
                            if ($object instanceof IsIncludableDDL && $this !== $object->getParent()) {
                                continue;
                            }
    ...
    public static function getPath($databaseName)
    {
        ...
        $file = self::getDirectory() . "$databaseName" . DDL::$extension;
    ...
    public static function getNameFromPath($path)
    {
        ...
        return basename("$path", DDL::$extension);
    }
        ...
        if (is_array($dirList)) {
            foreach ($dirList as $filename)
            {
                ...
                /* remove suffix: '.db.xml' */
                    ...
                    $list[] = basename($filename, DDL::$extension);
                }
            }
        }
        return $list;
