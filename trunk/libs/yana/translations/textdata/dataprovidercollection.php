...
class DataProviderCollection extends \Yana\Core\AbstractCollection
{
     ...
     * @param   \Yana\Translations\TextData\IsDataProvider   $value   new value of item
     * @throws  \Yana\Core\Exceptions\InvalidArgumentException  if the value is not a valid collection item
     * @return  \Yana\Translations\TextData\IsDataProvider
     */
    public function offsetSet($offset, $value)
    {
        if (!$value instanceof \Yana\Translations\TextData\IsDataProvider) {
