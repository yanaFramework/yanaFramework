...
class PasswordHash
{
    ...
    /**
     * @param int  $iteration_count_log2 number of iterations as power to 2 (Example: 8 = 2^8 = 256)
     * @param bool $portable_hashes      true: try most portable hash first, false: try most secure hash first
     */
     ...
     * @return string
     */
    protected function gensalt_sha($input)
    {
        $count_log2 = min($this->iteration_count_log2 + 8, 24);
        # This should be odd to not reveal weak DES keys, and the
        # maximum valid value is (2**24 - 1) which is odd anyway.
    ...
    /**
     * @param string $password text to encode
     * @return string
     * @throws \PhPass\NotImplementedException when unable to calculate a hash
     */
