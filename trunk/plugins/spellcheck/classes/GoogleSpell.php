...
class GoogleSpell extends SpellChecker
{
     ...
     * @return array
     */
	private function &_getMatches($lang, $str)
    {
		...
		$xml = '<?xml version="1.0" encoding="utf-8" ?>' .
            '<spellrequest textalreadyclipped="0" ignoredups="0" ignoredigits="1" ignoreallcaps="1"><text>' .
            $str . '</text></spellrequest>';
     ...
     *
     * @param string $string html entities in string
     * @return string
     */
