<?php
        if (!defined('YANA_DATABASE_ACTIVE'))   define('YANA_DATABASE_ACTIVE', false);
        if (!defined('YANA_DATABASE_DBMS'))     define('YANA_DATABASE_DBMS', "mysqli");
        if (!defined('YANA_DATABASE_HOST'))     define('YANA_DATABASE_HOST', "localhost");
