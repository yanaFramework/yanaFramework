            ...
            <ul class="comment">
<!-- {if $USER.USER_INSERTED} -->
                <li class="li_hint">{lang id="USER.PROFIL.1"} {$USER.USER_INSERTED|date} {if $USER.COUNT_LOGINS}{lang id="USER.PROFIL.1A"}{/if}</li>
<!-- {/if} -->
<!-- {if $USER.USER_LOGIN_LAST} -->
                <li class="li_pointer">{lang id="USER.PROFIL.2"} {$USER.USER_LOGIN_LAST|date}</li>
<!-- {/if} -->
<!-- {if $USER.USERPROFILE_MODIFIED} -->
