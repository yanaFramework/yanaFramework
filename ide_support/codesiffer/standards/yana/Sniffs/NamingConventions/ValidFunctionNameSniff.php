<?php
/**
 * YANA_Sniffs_NamingConventions_ValidFunctionNameSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class YANA_Sniffs_NamingConventions_ValidFunctionNameSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{
    ...
    /**
     * Constructs a YANA_Sniffs_NamingConventions_ValidFunctionNameSniff.
     */
    ...
    protected function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if (($isPublic === false && $isProtected === false) && $methodName{0} !== '_') {
        ...
        if (($isPublic === true && $isProtected === false) && $scopeSpecified === true && $methodName{0} === '_') {
        ...
        if (($isProtected === false) && ($isPublic === false)) {
