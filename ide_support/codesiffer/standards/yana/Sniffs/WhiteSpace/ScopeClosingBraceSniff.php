<?php
/**
 * YANA_Sniffs_Whitespace_ScopeClosingBraceSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class YANA_Sniffs_WhiteSpace_ScopeClosingBraceSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (in_array($tokens[$stackPtr]['code'], array(T_CASE, T_DEFAULT)) === true
            ...
            // BREAK statements should not be indented fewer spaces than
            // the CASE or DEFAULT statement.
