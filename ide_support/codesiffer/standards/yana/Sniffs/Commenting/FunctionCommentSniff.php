 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class YANA_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    protected function processReturn($commentStart, $commentEnd)
    {
        ...
        if ($isSpecialMethod === false && $methodName !== $className) {
            ...
            if (!is_null($return) && trim($return->getRawContent()) === '') {
    ...
    protected function processParams($commentStart)
    {
        ...
        if (empty($params) === false) {
            ...
            foreach ($params as $param) {
                ...
                // Make sure that there is a space before the var type (one or more are allowed).
                ...
                if ($paramComment === '') {
                    $warning = 'Missing comment for param "'.$paramName.'" at position '.$pos;
                    $this->currentFile->addWarning($warning, $errorPos);
                }
            ...
            if ($spaceBeforeVar <= 0 && $spaceBeforeVar !== 10000 && $spaceBeforeComment !== 10000) {
                $error = 'Expected 1 space after the longest type';
                $this->currentFile->addError($error, $longestType);
            }

            if ($spaceBeforeComment <= 0 && $spaceBeforeComment !== 10000) {
