...
if (class_exists('YANA_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class YANA_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class YANA_Sniffs_Commenting_ClassCommentSniff extends YANA_Sniffs_Commenting_FileCommentSniff
{
