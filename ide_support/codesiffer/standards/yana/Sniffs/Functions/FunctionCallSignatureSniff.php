<?php
/**
 * YANA_Sniffs_Functions_FunctionCallSignatureSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class YANA_Sniffs_Functions_FunctionCallSignatureSniff implements PHP_CodeSniffer_Sniff
{
        ...
        for ($i = ($openBracket + 1); $i < $closeBracket; $i++) {
            ...
            if ($tokens[$i]['line'] !== $lastLine) {
                ...
                if ($tokens[$i]['line'] === $tokens[$closeBracket]['line']) {
                    ...
                    $expectedIndent = (int) $functionIndent;
                } else {
                    $expectedIndent = (int) ($functionIndent + 4);
                }

                if ($tokens[$i]['code'] !== T_WHITESPACE) {
                    $foundIndent = 0;
                } else {
                    $foundIndent = (int) strlen($tokens[$i]['content']);
                }
